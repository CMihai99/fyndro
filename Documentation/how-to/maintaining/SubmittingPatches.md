...
For a list of items to check before submitting code, read [SubmitChecklist.md](https://github.com/CMihai99/fyndro/blob/main/Documentation/how-to/maintaining/SubmittingChecklist.md).
...
be easily pulled into Fyndro's source code management system, git, as a commit log.
...
See [/SecurityBugs.md](https://github.com/CMihai99/fyndro/blob/main/Documentation/how-to/SecurityBugs.md).
...
thorough reviews, will normally increase the likelihood of your patch getting into Fyndro.
